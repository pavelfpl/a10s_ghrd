...
set ::GLOBAL_a10s_ghrd_altera_emif_arch_nf_181_ccplvsq_corename a10s_ghrd_altera_emif_arch_nf_181_ccplvsq
...
set var(tQH)                                                     0.43
set var(tDS)                                                     0.046875029296893314
set var(tDH)                                                     0.046875029296893314
set var(tIS)                                                     0.062
set var(tIH)                                                     0.087
...
set var(tDSS)                                                    0.18
set var(tDSH)                                                    0.18
set var(BD_PKG_SKEW)                                             0.00142042
set var(CA_BD_PKG_SKEW)                                          0.002694888
set var(CA_TO_CK_BD_PKG_SKEW)                                    -8.83595E-5
set var(DQS_BOARD_SKEW)                                          0.098106304
set var(DQS_TO_CK_BOARD_SKEW)                                    -0.08659949
...
set var(PHY_MEM_CLK_FREQ_MHZ)                                    1066.666
