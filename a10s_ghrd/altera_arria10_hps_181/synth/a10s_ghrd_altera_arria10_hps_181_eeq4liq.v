// a10s_ghrd_altera_arria10_hps_181_eeq4liq.v
...
`timescale 1 ps / 1 ps
module a10s_ghrd_altera_arria10_hps_181_eeq4liq #(
		...
		output wire [63:0]   f2sdram0_RDATA,            //                    .rdata
		...
		input  wire          f2s_sdram1_rst,            //      f2sdram1_reset.reset_n
		...
		input  wire [3:0]    f2sdram1_AWLEN,            //                    .awlen
		input  wire [1:0]    f2sdram1_AWLOCK,           //                    .awlock
		input  wire [2:0]    f2sdram1_AWPROT,           //                    .awprot
		output wire          f2sdram1_AWREADY,          //                    .awready
		input  wire [2:0]    f2sdram1_AWSIZE,           //                    .awsize
		input  wire [4:0]    f2sdram1_AWUSER,           //                    .awuser
		input  wire          f2sdram1_AWVALID,          //                    .awvalid
		input  wire [63:0]   f2sdram1_WDATA,            //                    .wdata
		input  wire [3:0]    f2sdram1_WID,              //                    .wid
		input  wire          f2sdram1_WLAST,            //                    .wlast
		output wire          f2sdram1_WREADY,           //                    .wready
		input  wire [7:0]    f2sdram1_WSTRB,            //                    .wstrb
		...
		output wire [63:0]   f2sdram1_RDATA,            //                    .rdata
	...
	a10s_ghrd_altera_arria10_interface_generator_140_cszhxoy fpga_interfaces (
		...
		.f2sdram1_clk       (f2sdram1_clk),       //      f2sdram1_clock.clk
		.f2s_sdram1_rst     (f2s_sdram1_rst),     //      f2sdram1_reset.reset_n
		.f2sdram1_ARADDR    (f2sdram1_ARADDR),    //       f2sdram1_data.araddr
		.f2sdram1_ARBURST   (f2sdram1_ARBURST),   //                    .arburst
		.f2sdram1_ARCACHE   (f2sdram1_ARCACHE),   //                    .arcache
		.f2sdram1_ARID      (f2sdram1_ARID),      //                    .arid
		.f2sdram1_ARLEN     (f2sdram1_ARLEN),     //                    .arlen
		.f2sdram1_ARLOCK    (f2sdram1_ARLOCK),    //                    .arlock
		.f2sdram1_ARPROT    (f2sdram1_ARPROT),    //                    .arprot
		.f2sdram1_ARREADY   (f2sdram1_ARREADY),   //                    .arready
		.f2sdram1_ARSIZE    (f2sdram1_ARSIZE),    //                    .arsize
		.f2sdram1_ARUSER    (f2sdram1_ARUSER),    //                    .aruser
		.f2sdram1_ARVALID   (f2sdram1_ARVALID),   //                    .arvalid
		.f2sdram1_AWADDR    (f2sdram1_AWADDR),    //                    .awaddr
		.f2sdram1_AWBURST   (f2sdram1_AWBURST),   //                    .awburst
		.f2sdram1_AWCACHE   (f2sdram1_AWCACHE),   //                    .awcache
		.f2sdram1_AWID      (f2sdram1_AWID),      //                    .awid
		.f2sdram1_AWLEN     (f2sdram1_AWLEN),     //                    .awlen
		.f2sdram1_AWLOCK    (f2sdram1_AWLOCK),    //                    .awlock
		.f2sdram1_AWPROT    (f2sdram1_AWPROT),    //                    .awprot
		.f2sdram1_AWREADY   (f2sdram1_AWREADY),   //                    .awready
		.f2sdram1_AWSIZE    (f2sdram1_AWSIZE),    //                    .awsize
		.f2sdram1_AWUSER    (f2sdram1_AWUSER),    //                    .awuser
		.f2sdram1_AWVALID   (f2sdram1_AWVALID),   //                    .awvalid
		.f2sdram1_WDATA     (f2sdram1_WDATA),     //                    .wdata
		.f2sdram1_WID       (f2sdram1_WID),       //                    .wid
		.f2sdram1_WLAST     (f2sdram1_WLAST),     //                    .wlast
		.f2sdram1_WREADY    (f2sdram1_WREADY),    //                    .wready
		.f2sdram1_WSTRB     (f2sdram1_WSTRB),     //                    .wstrb
		.f2sdram1_WVALID    (f2sdram1_WVALID),    //                    .wvalid
		.f2sdram1_BID       (f2sdram1_BID),       //                    .bid
		.f2sdram1_BREADY    (f2sdram1_BREADY),    //                    .bready
		.f2sdram1_BRESP     (f2sdram1_BRESP),     //                    .bresp
		.f2sdram1_BVALID    (f2sdram1_BVALID),    //                    .bvalid
		.f2sdram1_RDATA     (f2sdram1_RDATA),     //                    .rdata
		.f2sdram1_RID       (f2sdram1_RID),       //                    .rid
		.f2sdram1_RLAST     (f2sdram1_RLAST),     //                    .rlast
		.f2sdram1_RREADY    (f2sdram1_RREADY),    //                    .rready
		.f2sdram1_RRESP     (f2sdram1_RRESP),     //                    .rresp
		.f2sdram1_RVALID    (f2sdram1_RVALID),    //                    .rvalid
		.f2h_irq_p0         (f2h_irq_p0),         //            f2h_irq0.irq
		.f2h_irq_p1         (f2h_irq_p1)          //            f2h_irq1.irq
	);

	a10s_ghrd_altera_arria10_hps_io_181_y5i4mti hps_io (
