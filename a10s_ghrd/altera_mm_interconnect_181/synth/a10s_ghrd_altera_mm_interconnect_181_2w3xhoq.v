// a10s_ghrd_altera_mm_interconnect_181_2w3xhoq.v
...
`timescale 1 ps / 1 ps
module a10s_ghrd_altera_mm_interconnect_181_2w3xhoq (
	...
	wire          rsp_mux_src_valid;                                                // rsp_mux:src_valid -> arria10_hps_h2f_lw_axi_master_agent:write_rp_valid
	wire  [118:0] rsp_mux_src_data;                                                 // rsp_mux:src_data -> arria10_hps_h2f_lw_axi_master_agent:write_rp_data
	wire          rsp_mux_src_ready;                                                // arria10_hps_h2f_lw_axi_master_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [2:0] rsp_mux_src_channel;                                              // rsp_mux:src_channel -> arria10_hps_h2f_lw_axi_master_agent:write_rp_channel
	wire          rsp_mux_src_startofpacket;                                        // rsp_mux:src_startofpacket -> arria10_hps_h2f_lw_axi_master_agent:write_rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                          // rsp_mux:src_endofpacket -> arria10_hps_h2f_lw_axi_master_agent:write_rp_endofpacket
	wire          rsp_mux_001_src_valid;                                            // rsp_mux_001:src_valid -> arria10_hps_h2f_lw_axi_master_agent:read_rp_valid
	wire  [118:0] rsp_mux_001_src_data;                                             // rsp_mux_001:src_data -> arria10_hps_h2f_lw_axi_master_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                                            // arria10_hps_h2f_lw_axi_master_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                          // rsp_mux_001:src_channel -> arria10_hps_h2f_lw_axi_master_agent:read_rp_channel
	wire          rsp_mux_001_src_startofpacket;                                    // rsp_mux_001:src_startofpacket -> arria10_hps_h2f_lw_axi_master_agent:read_rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                      // rsp_mux_001:src_endofpacket -> arria10_hps_h2f_lw_axi_master_agent:read_rp_endofpacket
	...
	wire  [118:0] rsp_mux_002_src_data;                                             // rsp_mux_002:src_data -> fpga_m_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                            // fpga_m_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                          // rsp_mux_002:src_channel -> fpga_m_master_agent:rp_channel
	...
	wire  [118:0] arria10_hps_h2f_lw_axi_master_agent_write_cp_data;                // arria10_hps_h2f_lw_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [118:0] arria10_hps_h2f_lw_axi_master_agent_read_cp_data;                 // arria10_hps_h2f_lw_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [118:0] fpga_m_master_agent_cp_data;                                      // fpga_m_master_agent:cp_data -> router_002:sink_data
	...
	wire          pb_lwh2f_s0_agent_rp_valid;                                       // pb_lwh2f_s0_agent:rp_valid -> router_003:sink_valid
	wire  [118:0] pb_lwh2f_s0_agent_rp_data;                                        // pb_lwh2f_s0_agent:rp_data -> router_003:sink_data
	wire          pb_lwh2f_s0_agent_rp_ready;                                       // router_003:sink_ready -> pb_lwh2f_s0_agent:rp_ready
	wire          pb_lwh2f_s0_agent_rp_startofpacket;                               // pb_lwh2f_s0_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          pb_lwh2f_s0_agent_rp_endofpacket;                                 // pb_lwh2f_s0_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          pb_lwh2f_s0_burst_adapter_source0_valid;                          // pb_lwh2f_s0_burst_adapter:source0_valid -> pb_lwh2f_s0_agent:cp_valid
	wire  [118:0] pb_lwh2f_s0_burst_adapter_source0_data;                           // pb_lwh2f_s0_burst_adapter:source0_data -> pb_lwh2f_s0_agent:cp_data
	wire          pb_lwh2f_s0_burst_adapter_source0_ready;                          // pb_lwh2f_s0_agent:cp_ready -> pb_lwh2f_s0_burst_adapter:source0_ready
	wire    [2:0] pb_lwh2f_s0_burst_adapter_source0_channel;                        // pb_lwh2f_s0_burst_adapter:source0_channel -> pb_lwh2f_s0_agent:cp_channel
	wire          pb_lwh2f_s0_burst_adapter_source0_startofpacket;                  // pb_lwh2f_s0_burst_adapter:source0_startofpacket -> pb_lwh2f_s0_agent:cp_startofpacket
	wire          pb_lwh2f_s0_burst_adapter_source0_endofpacket;                    // pb_lwh2f_s0_burst_adapter:source0_endofpacket -> pb_lwh2f_s0_agent:cp_endofpacket
	...
	wire  [118:0] cmd_demux_001_src0_data;                                          // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [118:0] cmd_demux_002_src0_data;                                          // cmd_demux_002:src0_data -> cmd_mux:sink2_data
	...
	wire  [118:0] rsp_demux_src1_data;                                              // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [118:0] rsp_demux_src2_data;                                              // rsp_demux:src2_data -> rsp_mux_002:sink0_data
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (pb_lwh2f_s0_burst_adapter_source0_ready),                  //              cp.ready
		.cp_valid                (pb_lwh2f_s0_burst_adapter_source0_valid),                  //                .valid
		.cp_data                 (pb_lwh2f_s0_burst_adapter_source0_data),                   //                .data
		.cp_startofpacket        (pb_lwh2f_s0_burst_adapter_source0_startofpacket),          //                .startofpacket
		.cp_endofpacket          (pb_lwh2f_s0_burst_adapter_source0_endofpacket),            //                .endofpacket
		.cp_channel              (pb_lwh2f_s0_burst_adapter_source0_channel),                //                .channel
	...
	a10s_ghrd_altera_merlin_router_181_yloihfq router (
	...
	a10s_ghrd_altera_merlin_router_181_yloihfq router_001 (
	...
	a10s_ghrd_altera_merlin_router_181_yloihfq router_002 (
	...
	a10s_ghrd_altera_merlin_router_181_4abqbui router_003 (
		.sink_ready         (pb_lwh2f_s0_agent_rp_ready),                               //      sink.ready
		.sink_valid         (pb_lwh2f_s0_agent_rp_valid),                               //          .valid
		.sink_data          (pb_lwh2f_s0_agent_rp_data),                                //          .data
		.sink_startofpacket (pb_lwh2f_s0_agent_rp_startofpacket),                       //          .startofpacket
		.sink_endofpacket   (pb_lwh2f_s0_agent_rp_endofpacket),                         //          .endofpacket
		.clk                (clk_100_clk_clk),                                          //       clk.clk
		.reset              (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_demultiplexer_181_obrwnpa cmd_demux (
		.clk                (clk_100_clk_clk),                                          //       clk.clk
		.reset              (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_demultiplexer_181_obrwnpa cmd_demux_001 (
		.clk                (clk_100_clk_clk),                                          //       clk.clk
		.reset              (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_demultiplexer_181_obrwnpa cmd_demux_002 (
		.clk                (clk_100_clk_clk),                                          //       clk.clk
		.reset              (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_multiplexer_181_zoswswa cmd_mux (
		.clk                 (clk_100_clk_clk),                                          //       clk.clk
		.reset               (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_demultiplexer_181_yfxh77q rsp_demux (
		.clk                (clk_100_clk_clk),                                          //       clk.clk
		.reset              (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_multiplexer_181_nzjnjka rsp_mux (
		.clk                 (clk_100_clk_clk),                                          //       clk.clk
		.reset               (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_multiplexer_181_nzjnjka rsp_mux_001 (
		.clk                 (clk_100_clk_clk),                                          //       clk.clk
		.reset               (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_multiplexer_181_nzjnjka rsp_mux_002 (
		.clk                 (clk_100_clk_clk),                                          //       clk.clk
		.reset               (arria10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
