// a10s_ghrd_altera_mm_interconnect_181_u7e5kea.v
...
`timescale 1 ps / 1 ps
module a10s_ghrd_altera_mm_interconnect_181_u7e5kea (
	...
	wire          onchip_memory2_s1_agent_rp_valid;                        // onchip_memory2_s1_agent:rp_valid -> router_002:sink_valid
	wire   [93:0] onchip_memory2_s1_agent_rp_data;                         // onchip_memory2_s1_agent:rp_data -> router_002:sink_data
	wire          onchip_memory2_s1_agent_rp_ready;                        // router_002:sink_ready -> onchip_memory2_s1_agent:rp_ready
	wire          onchip_memory2_s1_agent_rp_startofpacket;                // onchip_memory2_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          onchip_memory2_s1_agent_rp_endofpacket;                  // onchip_memory2_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire   [93:0] onchip_memory2_s1_burst_adapter_source0_data;            // onchip_memory2_s1_burst_adapter:source0_data -> onchip_memory2_s1_agent:cp_data
	...
	wire    [1:0] onchip_memory2_s1_burst_adapter_source0_channel;         // onchip_memory2_s1_burst_adapter:source0_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire          router_002_src_valid;                                    // router_002:src_valid -> onchip_memory2_s1_rsp_width_adapter:in_valid
	wire   [93:0] router_002_src_data;                                     // router_002:src_data -> onchip_memory2_s1_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                    // onchip_memory2_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                  // router_002:src_channel -> onchip_memory2_s1_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                            // router_002:src_startofpacket -> onchip_memory2_s1_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                              // router_002:src_endofpacket -> onchip_memory2_s1_rsp_width_adapter:in_endofpacket
	wire          onchip_memory2_s1_rsp_width_adapter_src_valid;           // onchip_memory2_s1_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [156:0] onchip_memory2_s1_rsp_width_adapter_src_data;            // onchip_memory2_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          onchip_memory2_s1_rsp_width_adapter_src_ready;           // rsp_demux:sink_ready -> onchip_memory2_s1_rsp_width_adapter:out_ready
	wire    [1:0] onchip_memory2_s1_rsp_width_adapter_src_channel;         // onchip_memory2_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          onchip_memory2_s1_rsp_width_adapter_src_startofpacket;   // onchip_memory2_s1_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          onchip_memory2_s1_rsp_width_adapter_src_endofpacket;     // onchip_memory2_s1_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                       // cmd_mux:src_valid -> onchip_memory2_s1_cmd_width_adapter:in_valid
	wire  [156:0] cmd_mux_src_data;                                        // cmd_mux:src_data -> onchip_memory2_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                       // onchip_memory2_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                     // cmd_mux:src_channel -> onchip_memory2_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                               // cmd_mux:src_startofpacket -> onchip_memory2_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                 // cmd_mux:src_endofpacket -> onchip_memory2_s1_cmd_width_adapter:in_endofpacket
	...
	wire   [93:0] onchip_memory2_s1_cmd_width_adapter_src_data;            // onchip_memory2_s1_cmd_width_adapter:out_data -> onchip_memory2_s1_burst_adapter:sink0_data
	...
	wire    [1:0] onchip_memory2_s1_cmd_width_adapter_src_channel;         // onchip_memory2_s1_cmd_width_adapter:out_channel -> onchip_memory2_s1_burst_adapter:sink0_channel
	...
	wire          onchip_memory2_s1_agent_rdata_fifo_out_valid;            // onchip_memory2_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire    [9:0] onchip_memory2_s1_agent_rdata_fifo_out_data;             // onchip_memory2_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          onchip_memory2_s1_agent_rdata_fifo_out_ready;            // avalon_st_adapter:in_0_ready -> onchip_memory2_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                           // avalon_st_adapter:out_0_valid -> onchip_memory2_s1_agent:rdata_fifo_sink_valid
	wire    [9:0] avalon_st_adapter_out_0_data;                            // avalon_st_adapter:out_0_data -> onchip_memory2_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                           // onchip_memory2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                           // avalon_st_adapter:out_0_error -> onchip_memory2_s1_agent:rdata_fifo_sink_error
	...
	a10s_ghrd_altera_merlin_router_181_jalzaga router (
	...
	a10s_ghrd_altera_merlin_router_181_jalzaga router_001 (
	...
	a10s_ghrd_altera_merlin_router_181_dpsqb6i router_002 (
	...
	a10s_ghrd_altera_merlin_demultiplexer_181_uhus3qi cmd_demux (
		.clk                (clk_100_clk_clk),                                       //       clk.clk
		.reset              (arria10_hps_h2f_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_demultiplexer_181_uhus3qi cmd_demux_001 (
		.clk                (clk_100_clk_clk),                                       //       clk.clk
		.reset              (arria10_hps_h2f_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_multiplexer_181_sgkkm3y cmd_mux (
		.clk                 (clk_100_clk_clk),                                   //       clk.clk
		.reset               (onchip_memory2_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_demultiplexer_181_tdxkbly rsp_demux (
		.clk                (clk_100_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_multiplexer_181_vfnb4aq rsp_mux (
		.clk                 (clk_100_clk_clk),                                       //       clk.clk
		.reset               (arria10_hps_h2f_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	a10s_ghrd_altera_merlin_multiplexer_181_vfnb4aq rsp_mux_001 (
		.clk                 (clk_100_clk_clk),                                       //       clk.clk
		.reset               (arria10_hps_h2f_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
