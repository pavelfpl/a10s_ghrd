// a10s_ghrd_altera_emif_a10_hps_181_oeawlci.v
...
`timescale 1 ps / 1 ps
module a10s_ghrd_altera_emif_a10_hps_181_oeawlci (
	...
	a10s_ghrd_altera_emif_arch_nf_181_ccplvsq #(
		...
		.C2P_P2C_CLK_RATIO                          (2),
		.PHY_HMC_CLK_RATIO                          (2),
		.DIAG_ABSTRACT_PHY_WLAT                     (8),
		.DIAG_ABSTRACT_PHY_RLAT                     (19),
		.DIAG_CPA_OUT_1_EN                          (0),
		.DIAG_USE_CPA_LOCK                          (1),
		...
		.PINS_USAGE_1                               (1073479739),
		.PINS_USAGE_2                               (1056960510),
		.PINS_USAGE_3                               (63),
		.PINS_USAGE_4                               (0),
		.PINS_USAGE_5                               (0),
		.PINS_USAGE_6                               (0),
		...
		.PINS_DB_IN_BYPASS_1                        (262203),
		.PINS_DB_IN_BYPASS_2                        (0),
		...
		.PINS_DB_OUT_BYPASS_1                       (262203),
		.PINS_DB_OUT_BYPASS_2                       (0),
		...
		.PINS_DB_OE_BYPASS_1                        (262203),
		.PINS_DB_OE_BYPASS_2                        (0),
		...
		.UNUSED_MEM_PINS_PINLOC_0                   (75583511),
		.UNUSED_MEM_PINS_PINLOC_1                   (48282684),
		...
		.PRI_HMC_CFG_SB_DDR4_MR3                    (197120),
		...
		.PRI_HMC_CFG_ACT_TO_RDWR                    (8),
		.PRI_HMC_CFG_ACT_TO_PCH                     (18),
		.PRI_HMC_CFG_ACT_TO_ACT                     (26),
		.PRI_HMC_CFG_ACT_TO_ACT_DIFF_BANK           (4),
		.PRI_HMC_CFG_ACT_TO_ACT_DIFF_BG             (4),
		...
		.PRI_HMC_CFG_RD_TO_WR_DIFF_BG               (7),
		.PRI_HMC_CFG_RD_TO_PCH                      (5),
		.PRI_HMC_CFG_RD_AP_TO_VALID                 (13),
		.PRI_HMC_CFG_WR_TO_WR                       (3),
		.PRI_HMC_CFG_WR_TO_WR_DIFF_CHIP             (3),
		.PRI_HMC_CFG_WR_TO_WR_DIFF_BG               (2),
		.PRI_HMC_CFG_WR_TO_RD                       (17),
		.PRI_HMC_CFG_WR_TO_RD_DIFF_CHIP             (5),
		.PRI_HMC_CFG_WR_TO_RD_DIFF_BG               (15),
		.PRI_HMC_CFG_WR_TO_PCH                      (19),
		.PRI_HMC_CFG_WR_AP_TO_VALID                 (27),
		.PRI_HMC_CFG_PCH_TO_VALID                   (8),
		.PRI_HMC_CFG_PCH_ALL_TO_VALID               (8),
		...
		.SEC_HMC_CFG_SB_DDR4_MR3                    (197120),
		...
		.SEC_HMC_CFG_ACT_TO_RDWR                    (8),
		.SEC_HMC_CFG_ACT_TO_PCH                     (18),
		.SEC_HMC_CFG_ACT_TO_ACT                     (26),
		.SEC_HMC_CFG_ACT_TO_ACT_DIFF_BANK           (4),
		.SEC_HMC_CFG_ACT_TO_ACT_DIFF_BG             (4),
		...
		.SEC_HMC_CFG_RD_TO_WR_DIFF_BG               (7),
		.SEC_HMC_CFG_RD_TO_PCH                      (5),
		.SEC_HMC_CFG_RD_AP_TO_VALID                 (13),
		.SEC_HMC_CFG_WR_TO_WR                       (3),
		.SEC_HMC_CFG_WR_TO_WR_DIFF_CHIP             (3),
		.SEC_HMC_CFG_WR_TO_WR_DIFF_BG               (2),
		.SEC_HMC_CFG_WR_TO_RD                       (17),
		.SEC_HMC_CFG_WR_TO_RD_DIFF_CHIP             (5),
		.SEC_HMC_CFG_WR_TO_RD_DIFF_BG               (15),
		.SEC_HMC_CFG_WR_TO_PCH                      (19),
		.SEC_HMC_CFG_WR_AP_TO_VALID                 (27),
		.SEC_HMC_CFG_PCH_TO_VALID                   (8),
		.SEC_HMC_CFG_PCH_ALL_TO_VALID               (8),
		...
		.PORT_MEM_ALERT_N_PINLOC_0                  (49153),
		...
		.PLL_REF_CLK_FREQ_PS_STR                    ("3752 ps"),
		.PLL_REF_CLK_FREQ_PS                        (3752),
		...
		.PLL_REF_CLK_FREQ_PS_STR_FROM_API           ("3752 ps"),
		.PLL_VCO_FREQ_PS_STR_FROM_API               ("938 ps"),
		.PLL_M_CNT_HIGH                             (2),
		.PLL_M_CNT_LOW                              (2),
		.PLL_N_CNT_HIGH                             (256),
		.PLL_N_CNT_LOW                              (256),
		...
		.global_reset_n                 (global_reset_n),                                                                                                                        // global_reset_reset_sink.reset_n
		.pll_ref_clk                    (pll_ref_clk),                                                                                                                           //  pll_ref_clk_clock_sink.clk
		.oct_rzqin                      (oct_rzqin),                                                                                                                             //         oct_conduit_end.oct_rzqin
		.mem_ck                         (mem_ck),                                                                                                                                //         mem_conduit_end.mem_ck
		...
		.hps_to_emif                    (hps_to_emif),                                                                                                                           //    hps_emif_conduit_end.hps_to_emif
		.emif_to_hps                    (emif_to_hps),                                                                                                                           //                        .emif_to_hps
		.hps_to_emif_gp                 (hps_to_emif_gp),                                                                                                                        //                        .gp_to_emif
		.emif_to_hps_gp                 (emif_to_hps_gp),                                                                                                                        //                        .emif_to_gp
		.mem_c                          (),                                                                                                                                      //             (terminated)
		.mem_rm                         (),                                                                                                                                      //             (terminated)
		.mem_dk                         (),                                                                                                                                      //             (terminated)
		.mem_dk_n                       (),                                                                                                                                      //             (terminated)
