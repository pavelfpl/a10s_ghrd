...
module a10s_ghrd_altera_merlin_router_181_auphfli_default_decode
  #(
...
module a10s_ghrd_altera_merlin_router_181_auphfli
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    a10s_ghrd_altera_merlin_router_181_auphfli_default_decode the_default_decode(
    ...
    // ( 0x40020 .. 0x40030 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 19'h40020  && write_transaction  ) begin
    ...
    // ( 0x41020 .. 0x41030 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 19'h41020  && write_transaction  ) begin
