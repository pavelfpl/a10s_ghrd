...
module a10s_ghrd_altera_merlin_router_181_45pxmci_default_decode
  #(
...
module a10s_ghrd_altera_merlin_router_181_45pxmci
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    a10s_ghrd_altera_merlin_router_181_45pxmci_default_decode the_default_decode(
    ...
    // ( 0x110 .. 0x120 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 9'h110   ) begin
    ...
    // ( 0x130 .. 0x138 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 9'h130  && read_transaction  ) begin
